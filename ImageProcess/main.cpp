...
int main(int argc, char *argv[])
{
	...
	int start = clock();
	string workDir("C:/Users/SUS/Pictures");
	string outputDir = "C:/Users/SUS/Pictures";
	...
	string imageDir = "C:/Users/SUS/Pictures";
	vector<string> testList;
	int numTest = load_image_list(workDir + "test.txt", testList);
	HSuperpixel hsp;
	string inputName;
	string outputName;
	string tag("_flic");
